...
export const Home = () => {
  // Sample products array with categories
  const products = [
    {
      name: 'Atomic Habits',
      brand: 'James Clear',
  ...
  const otherProducts = products.filter(p => p.category !== 'Books');
  ...
  return (
    <div style={{ padding: "2rem", background: "#181a1b", minHeight: "100vh" }}>
      ...
      <section style={{ margin: '40px 0' }}>
        <h2 style={{ color: '#4facfe', fontWeight: 700, marginBottom: 20, textShadow: '0 2px 8px #0008' }}>Products</h2>
